...
class Program
{
    private static readonly string googleApiKey = "YOUR_API_KEY_HERE";
    private static readonly string imagePath = "YOUR_API_KEY_HERE";
    ...
    static async Task Main()
    {
        ...
        Console.WriteLine("Tespit Sonuçları: \n");
